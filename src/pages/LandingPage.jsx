      ...
      <section className="relative bg-gradient-to-r from-primary-600 to-secondary-600 min-h-screen flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            Rasakan Sensasi
            <span className="block text-orange-300">Trail Running</span>
          </h1>
          <p className="text-xl md:text-2xl text-white mb-8 max-w-3xl mx-auto">
            Bergabunglah dengan komunitas trail running terbesar di Indonesia. 
            Jelajahi keindahan alam sambil menantang diri Anda dalam setiap langkah.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/events" className="btn-primary text-lg px-8 py-4">
              Lihat Event
            </Link>
            <Link to="/register" className="btn-outline bg-white text-primary-600 hover:bg-primary-600 hover:text-white text-lg px-8 py-4">
              Daftar Sekarang
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-navy-600 max-w-2xl mx-auto ">
              Kami menghadirkan pengalaman trail running yang tak terlupakan dengan fasilitas terbaik
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card text-center">
              ...
              <p className="text-navy-600">
                Rute trail running di lokasi-lokasi indah dengan pemandangan alam yang menakjubkan
              </p>
            </div>
            ...
            <div className="card text-center">
              ...
              <p className="text-navy-600">
                Bergabung dengan ribuan runner yang passionate dan saling mendukung
              </p>
            </div>
            ...
            <div className="card text-center">
              ...
              <p className="text-navy-600">
                Event trail running yang terorganisir dengan baik dan safety terjamin
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-navy-600 text-white">
              Jangan lewatkan kesempatan untuk berpartisipasi dalam event-event seru kami
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-navy-600 mb-6">
                Trail running bukan hanya olahraga biasa. Ini adalah cara hidup yang menggabungkan 
                kebugaran fisik, mental wellness, dan koneksi dengan alam.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-navy-900">Meningkatkan Kebugaran</h3>
                    <p className="text-navy-600">Latihan yang lebih menantang dari running biasa</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-navy-900">Mengurangi Stress</h3>
                    <p className="text-navy-600">Terapi alami di tengah keindahan alam</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-navy-900">Membangun Komunitas</h3>
                    <p className="text-navy-600">Bertemu dengan orang-orang yang berpikiran sama</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  <CheckCircleIcon className="h-6 w-6 text-primary-600 mr-3 flex-shrink-0 mt-0.5" />
                  <div>
                    <h3 className="font-semibold text-navy-900">Menjelajahi Alam</h3>
                    <p className="text-navy-600">Menemukan tempat-tempat indah yang tersembunyi</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600 to-navy-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white mb-8 max-w-2xl mx-auto">
            Bergabunglah dengan komunitas trail running terbesar di Indonesia dan mulai petualangan Anda hari ini!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/register" className="btn-secondary bg-white text-primary-600 hover:bg-gray-100 text-lg px-8 py-4">
              Daftar Sekarang
            </Link>
